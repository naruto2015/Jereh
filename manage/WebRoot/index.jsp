...
<div class="easyui-layout" fit="true">
    ...
    style="width:150px;">
    	<div id="nav" class="easyui-accordion" data-options="fit:true">
            ...
            <div title="基础管理" iconCls="icon-gear">
            	<ul>
                	<li><a href="#" onclick="addTab('往来单位管理','base/put.html')">往来单位管理</a></li>
                    <li><a href="#" onclick="addTab('字典内容管理','base/out.html')">字典内容管理</a></li>
                    <li><a href="#" onclick="addTab('配件类别管理','base/PartTypeManage.jsp')">配件类别管理</a></li>
                    <li><a href="#" onclick="addTab('配件信息管理','base/allot.html')">配件信息管理</a></li>
                    <li><a href="#" onclick="addTab('公司信息管理','base/info.html')">公司信息管理</a></li>
                </ul>
            </div>
    ...
    <div region="center"   fit="true" title="工作区域">
